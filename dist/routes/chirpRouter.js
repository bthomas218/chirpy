...
import { postChirp, getChirp, listChirps, deleteChirp, } from "../controllers/chirpController.js";
...
chirpRouter.post("/", extractAuthorizationMiddleware, extractUserMiddleware, postChirp);
chirpRouter.delete("/:id", extractAuthorizationMiddleware, extractUserMiddleware, deleteChirp);
